        ...
        <div class="relative inline-block text-left">
          ...
          >
            <div class="py-1" role="none">
              <a>
                <div
                  className={`flex flex-1 gap-2 p-4 justify-center items-center  scienceTabsbtns ${
              ...
              <a>
                <div
                  className={`flex flex-1 gap-2 justify-center items-center p-4 scienceTabsbtns ${
              ...
              <a>
                <div
                  className={`flex flex-1 gap-2 justify-center items-center text-center p-4  scienceTabsbtns ${
                    activeTab === 3
